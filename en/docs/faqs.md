...
The public certificate of the token service, which is used to sign the token, should be added to the trust store of WSO2 API Microgateway. The JWT should have the claims **iss, sub, aud** in order for the API Microgateway to validate the JWT.
